...
## 🛵 ◍ Demo: https://blackcat-nextjs.vercel.app/
...
- You might [need to overwrite default output derictory](https://github.com/thuglabs/blackcat-nextjs/issues/23) for vercel settings if you see [`Routes Manifest Could Not Be Found
