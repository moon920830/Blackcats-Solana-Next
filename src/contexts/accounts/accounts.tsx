...
import {
  TokenAccount,
  StringPublicKey, WRAPPED_SOL_MINT,
  programIds,
  // genericCache,
  // cache,
  // deserializeAccount,
...
export function AccountsProvider({
  ...
  console.log('AccountsProvider')

  const connection = useConnection();
  console.log('AccountsProvider.connection', connection);
  ...
  console.log('AccountsProvider.walletKey', walletKey);

  const selectUserAccounts = useCallback(() => {
    console.log('AccountsProvider.selectUserAccounts');
    return cache
  ...
  useEffect(() => {
    ...
    console.log('AccountsProvider.accounts', accounts);
