...
import {
  ...
  StoreIndexer,
} from '@oysterr/common/dist/lib/models/metaplex/index';
import { createTokenAccount } from '@oysterr/common/dist/lib/actions/account';
...
import { deprecatedValidateParticipation } from '@oysterr/common/dist/lib/models/metaplex/deprecatedValidateParticipation';
...
import { validateSafetyDepositBoxV2 } from '@oysterr/common/dist/lib/models/metaplex/validateSafetyDepositBoxV2';
import { initAuctionManagerV2 } from '@oysterr/common/dist/lib/models/metaplex/initAuctionManagerV2';
...
export async function createAuctionManager(
  ...
  console.log('createAuctionManager.createVault.valut', vault);
  ...
  console.log('createAuctionManager.makeAuction.auction', auction);
  ...
  console.log('createAuctionManager.setupAuctionManagerInstructions.auctionManager', auctionManager);
